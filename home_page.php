    ...
    <section id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h2>A propos</h2>
                    <p>Actuellement <strong>150 millions</strong> d’objets de 1 mm ou plus sont en orbite autour de la terre. Au delà de l’enjeu écologique que cette triste réalité représente, c’est une menace pour les futures conquêtes spatiales. Il s’agit
                        là « d’une pollution industrielle d’un genre nouveau, foudroyant, proliférant et durable » à l’image de la pollution de l’océan par le plastique, le polystyrène et les hydrocarbures.</p>
